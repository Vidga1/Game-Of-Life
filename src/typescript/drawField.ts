 ...
 * @returns void
 */
export function drawField(htmlElement: HTMLElement, field: number[][], onCellClick: (x: number, y: number) => void): void {
    const rowIterator = (row: number[], rowIndex: number): string => `<tr>${row
